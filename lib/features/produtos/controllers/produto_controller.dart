...
class ProdutoController extends ChangeNotifier {
  ...
  final _produto = ValueNotifier<ProdutoModel?>(null);
  ...
  ValueNotifier<ProdutoModel?> get produto => _produto;
  ...
  Future<void> carregarProdutos() async {
    ...
    try {
      ...
      _produtos.value = produtosJson
          .map((json) => ProdutoModel.fromJson(jsonDecode(json)))
          .toList();
      _error = null;
    } catch (e) {
